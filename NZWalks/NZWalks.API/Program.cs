...
using NZWalks.API.Repositories.TokenImplementations;
using System.Text;
...
// Register the Auth DbContext with dependency injection
builder.Services.AddDbContext<NZWalksAuthDbContext>(options =>
    options.UseSqlServer(builder.Configuration.GetConnectionString("NZWalksAuthCS")));
